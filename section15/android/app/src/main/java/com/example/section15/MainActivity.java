...
public class MainActivity extends FlutterActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Establishes communication over channel
        new MethodChannel(getFlutterEngine().getDartExecutor().getBinaryMessenger(), "course.flutter.dev/battery").setMethodCallHandler(
